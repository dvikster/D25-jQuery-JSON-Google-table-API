...
// $(document).ready(function(){
    ...
    console.log('m', m);
        ...
        //         console.log('thistest', b, this[arrayData2[b]]['$t']);
        //         arrayData4.push(
        //             this[arrayData2[b]]['$t']
        //         );
        //     }
        ...
        console.log('thistestArray', arrayData4);
        ...
        for(var a=0; a< m.length; a++){
                ...
                for(var b=0; b <arrayData2.length; b++) {
                    // console.log(a, b, m[a][arrayData2[b]]['$t']);
                   // for (var z=0; z <m.length; z++){

                       // arrayDatan=arrayData+z;
                    if (a == 0){
                        arrayData3.push(
                            m[a][arrayData2[b]]['$t']
                        );
        ...
        arrayData.push(
            arrayData3, arrayData4, arrayData5, arrayData6
        );
        ...
        console.log('23', arrayData3);
        console.log('24', arrayData4);
